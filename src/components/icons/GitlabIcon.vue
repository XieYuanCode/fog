<template>
  <svg t="1667201987767" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    p-id="3778" :width="props.size || 70" :height="props.size || 70">
    <path
      ...
      p-id="3779" fill="#4E5969" class="path"></path>
  </svg>
</template>
